...
class OrderMobileWithoutEdit extends StatefulWidget {
  BillWithReason bill;
  ...
  @override
  State<OrderMobileWithoutEdit> createState() => _OrderState();
}

class _OrderState extends State<OrderMobileWithoutEdit> {
  List<int> counter = [];
  late num result;
