                                                    ...
                                                    : Container(
                                                        ...
                                                        decoration:
                                                          ...
                                                          borderRadius:
                                                              BorderRadius
                                                                  .circular(4),
                                                          color: const Color.fromARGB(196, 33, 149, 243)
                                                        ),
                                                        child: Center(
                                                            child: CustomText(
                                                                text: 'تعديل العرض',
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child: Text(
                                                                              ...
                                                                              style: TextStyle(color: colorApp.basicColor, fontSize: 15, fontWeight: FontWeight.w700)),
                                                                        ),
                                                                        Container(
                                                                            width:
                                                                                200,
                                                                            ...
                                                                            child:
                                                                                myTextFieldNumber(
                                                                              phoneController: _updateOffer,
                                                                              phoneText: 'ادخل السعر الجديد',
                                                                            )),
                                                                        SizedBox(
                                                                          height:
                                                                              5,
