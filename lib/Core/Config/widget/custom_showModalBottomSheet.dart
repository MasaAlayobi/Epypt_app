...
class _CustomShowmodalbottomsheetState extends State<CustomShowmodalbottomsheet> {
  ...
  Widget build(BuildContext context) {
    return Directionality(textDirection: TextDirection.rtl, child: SizedBox(
                                              height: 600,
                                                  ...
                                                  children: [
                                                    ...
                                                    Divider(),
                                                     Padding(
                                                       ...
                                                       child: CustomText(text: 'علبة', size: 13, color: colorApp.blackColor, fontWeight: FontWeight.bold, maxLines: 1),
                                                     ),
                                                    Padding(
                                                      padding: const EdgeInsets.all(8.0),
                                                      child: Row(
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: CustomText(text: 'يوم انتهاء العرض', size: 13, color: colorApp.blackColor, fontWeight: FontWeight.bold, maxLines: 1),
                                                    ),
                                                    Padding(
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        height: 30,
                                                        color: colorApp.whiteColor,
                                                        child: Center(child: CustomText(text: 'تأكيد', size: 14, color: colorApp.blackColor, fontWeight: FontWeight.w700, maxLines: 1)),
                                                      ),
                                                    )
                                                  ],
                                                ),
