...
class Market {
  ...
  Market copyWith({
    ...
    return Market(
      ...
      subscription_expires_at: subscription_expires_at ?? this.subscription_expires_at,
  ...
  @override
  String toString() {
    return 'Market(location_details: $location_details, store_name: $store_name, city_name: $city_name, representator_code: $representator_code, subscription_expires_at: $subscription_expires_at, category_name: $category_name)';
  }
